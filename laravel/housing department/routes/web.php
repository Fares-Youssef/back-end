...
Route::middleware(['auth'])->group(function () {
    ...
    Route::prefix('housing')->group(function () {
        Route::get('', [App\Http\Controllers\HousingController::class, 'index'])->name('housing.index');
    ...
    Route::prefix('collection')->group(function () {
        ...
        Route::get('', [App\Http\Controllers\CollectionController::class, 'index'])->name('collection.index');
