                            ...
                            <div class="header__top__right__language d-inline ">
                                ...
                                <ul class="text-nowrap">
                                    ...
                                    <li class="d-flex justify-content-between align-items-center"><span
                                        class="badge text-bg-success">{{ $coll }}</span><a href="{{ route('notification.coll') }}">  طلبات المجمعات</a></li>
                                    @endif
                                        <li class="d-flex justify-content-between align-items-center"><span
                                        class="badge text-bg-success">{{ $building }}</span><a href="{{ route('notification.building') }}">  طلبات الوحدات</a></li>
                                    <li class="d-flex justify-content-between align-items-center"><span
                                        class="badge text-bg-success">{{ $housing }}</span><a href="{{ route('notification.housing') }}">  طلبات التسكين</a></li>
                                    <li class="d-flex justify-content-between align-items-center"><span
                                        class="badge text-bg-success">{{ $out }}</span><a href="{{ route('notification.out') }}">  طلبات الاخلاء</a></li>
                                </ul>
                            </div>
                        </li>
        ...
        <div class="aside_bar">
            <div class="menu-items">
                <ul class="nav-links">
                    ...
                    <li class="active"><a
                            @if (Auth::user()->type != 3) href="{{ route('collection.create') }}" @else href="{{ route('building.create') }}" @endif
