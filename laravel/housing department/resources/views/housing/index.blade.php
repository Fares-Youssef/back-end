...
@section('content')
        ...
        <div class="container ">
            <div class="row">
                        ...
                        <div class="card-body" style="height: 450px; overflow: scroll;">
                            ...
                            <div class="location mt-4">
                                <ul class="menu-Location menu-Location-region">
                                    <li class="item-Location" value="1">منطقة الرياض</li>
                                    <li class="item-Location" value="2">منطقة مكة المكرمة</li>
                                    <li class="item-Location" value="3">منطقة المدينة المنورة</li>
                                    <li class="item-Location" value="4">منطقة القصيم</li>
                                    <li class="item-Location" value="5">منطقة الشرقية</li>
                                    <li class="item-Location" value="6">منطقة عسير</li>
                                    <li class="item-Location" value="8">منطقة تبوك</li>
                                    <li class="item-Location" value="9">منطقة حائل</li>
                                    <li class="item-Location" value="10">منطقة الحدود الشماليه</li>
                                    <li class="item-Location" value="11">منطقة جازان</li>
                                    <li class="item-Location" value="12">منطقة نجران</li>
                                    <li class="item-Location" value="13">منطقة الباحة</li>
                                    <li class="item-Location" value="14">منطقة الجوف</li>
                                </ul>
                            </div>
                ...
                <div class="position-relative">
                    ...
                    <div class="modal fade" id="Rooms" tabindex="-1" role="dialog"
                        aria-labelledby="exampleModalLabel" aria-hidden="true" style="top: 12%; left: 0;">
    ...
    <script>
        ...
        var collection = @json($coll);
        var units = @json($building);
        var apartment = @json($apartment);
        var room = @json($room);
        var workers = @json($housing);
