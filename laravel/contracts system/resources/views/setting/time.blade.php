                                                ...
                                                @foreach ($times as $item)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <a onclick="return confirm('are you sure!')" href="{{ route('time.destroy', $item->id) }}" class="delete" ><i class="material-icons">&#xe872;</i></a>
                                                        </td>
                                                    </tr>
                                                @endforeach
                                            </tbody>
