...
@section('content')
    <div class="container  py-5">
        <div class="m-auto">
            ...
            @endif
            <form action="{{ route('out.store') }}" class="card card-md" method="post" enctype="multipart/form-data">
                @csrf
                <div class="card-body">
                    <h2 class="card-title text-center mb-4">تسجيل سحب جديد</h2>
                    <div class="row">
        ...
        <div class="card my-3">
            <div class="card-body border-bottom">
                <div class="row">
                    <div class="col">
                        <h3 class="card-title m-0">كل السحبات المسجلة</h3>
                    </div>
                </div>
            </div>
                    ...
                    <tbody>
                        @foreach ($out as $item)
                            <tr>
                                ...
                                <td>{{ $item->attach }}</td>
                                <td>
                                    <a href="{{ route('out.edit', $item->id) }}" class="btn btn-warning">
                                        تعديل
                                    </a>
                                </td>
                                <td>
                                    <a href="{{ route('out.destroy', $item->id) }}" class="btn btn-danger"
