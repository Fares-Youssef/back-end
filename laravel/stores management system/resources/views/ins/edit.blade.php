...
@section('content')
    <div class="container container-tight py-5">
        <div class="m-auto">
            ...
            @endif
            <form action="{{ route('in.update', $in->id) }}" class="card card-md" method="post"
                enctype="multipart/form-data">
                @csrf
                <div class="card-body">
                    <h2 class="card-title text-center mb-4">تعديل الايداع</h2>
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                            <div>
                                ...
                                <input type="date" class="form-control @error('date') is-invalid @enderror"
                                    name="date" value="{{ $in->date }}" autofocus>
                                @error('date')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
